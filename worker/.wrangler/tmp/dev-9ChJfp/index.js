...
// .wrangler/tmp/bundle-zITYrL/checked-fetch.js
  ...
  beforeSave: /* @__PURE__ */ __name((member) => {
    ...
    return {
      ...
      activity: JSON.stringify(
        (newMember.activity || "").split(",").map((s) => s.trim())
      ),
      mailstone: JSON.stringify(
        (newMember.mailstone || "").split(",").map((s) => s.trim())
      )
    };
  }, "beforeSave"),
...
// .wrangler/tmp/bundle-zITYrL/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-zITYrL/middleware-loader.entry.ts
