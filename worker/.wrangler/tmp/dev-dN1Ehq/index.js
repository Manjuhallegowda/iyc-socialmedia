...
// .wrangler/tmp/bundle-6GuAAg/checked-fetch.js
...
var createCrudEndpoints = /* @__PURE__ */ __name((router, tableName, options = {}) => {
  ...
  router.put(`${basePath}/:id`, jwtMiddleware, async (c) => {
    ...
    try {
      ...
      return c.json(transformAfterFetch(body));
    } catch (e) {
      return c.json({ error: e.message }, 500);
    }
  });
...
var executiveLeaderTransforms = {
  beforeSave: /* @__PURE__ */ __name((executiveLeader) => ({
    ...executiveLeader,
    social: JSON.stringify(executiveLeader.social || {})
  }), "beforeSave"),
  afterFetch: /* @__PURE__ */ __name((executiveLeader) => ({
    ...executiveLeader,
    social: JSON.parse(executiveLeader.social || "{}")
  }), "afterFetch")
};
...
// .wrangler/tmp/bundle-6GuAAg/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-6GuAAg/middleware-loader.entry.ts
