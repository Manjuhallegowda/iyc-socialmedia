...
import { Play, Youtube, X, Film } from 'lucide-react';
...
const VideoSection: React.FC = () => {
  ...
  return (
    <section
      id="videos"
      className="py-20 bg-gradient-to-br from-blue-500 to-blue-900 text-white scroll-mt-24 relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-blue-100 font-medium">
            Watch our latest rallies, press conferences, and digital campaigns.
          </p>
        </div>
            ...
            >
              <div className="relative aspect-video w-full bg-gray-900 overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="bg-white/20 backdrop-blur-md p-4 rounded-full border border-white/50 shadow-lg group-hover:scale-110 group-hover:bg-sky-400 group-hover:border-skyBlue transition-all duration-300">
                    <Play
                      size={32}
                      fill="currentColor"
              ...
              <div className="p-5">
                <div className="flex items-center gap-2 mb-2 text-indiaGreen text-xs font-bold uppercase tracking-wider">
                  <Film size={16} />
                  Featured Videos
                </div>
                <h3 className="text-lg font-bold text-indiaGreen group-hover:text-saffron transition-colors line-clamp-2 leading-tight">
                  {video.title}
                </h3>
              </div>
            </div>
