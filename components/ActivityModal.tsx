      ...
      >
        ...
        <div className="h-64 sm:h-80 w-full relative shrink-0">
          ...
          <div className="absolute bottom-6 left-6 right-6">
            <span
              className={`inline-block px-3 py-1 mb-3 text-xs font-bold text-white rounded uppercase tracking-wider ${
                activity.type === 'Protest' ? 'bg-red-600' : 'bg-saffron'
              }`}
            >
              {activity.type}
            </span>
        ...
        <div className="p-6 sm:p-8 space-y-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-indiaGreen">
              About the Campaign
            </h3>
          ...
          {activity.stats && activity.stats.length > 0 && (
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-100">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-bold text-indiaGreen">
                  Impact Highlights
                </h3>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                {activity.stats.map((stat, idx) => (
                  <div
                    key={idx}
                    className="text-center p-4 bg-white rounded-lg shadow-sm border-b-4 border-indiaGreen"
                  >
