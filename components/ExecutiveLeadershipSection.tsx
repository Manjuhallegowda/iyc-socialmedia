    ...
    >
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            Driving the vision and strategy for Indian Youth Congress at
          ...
          {executiveLeaders.map((leader, index) => (
            ...
            >
              ...
              <div className="p-6 flex-grow flex flex-col">
                <h3 className="text-xl font-bold text-indiaGreen mb-1">
                  {leader.name}
                </h3>
                <p className="text-saffron text-sm font-semibold mb-4">
                  {leader.title}
                </p>
                {leader.description && (
                  ...
                  <div className="flex justify-center space-x-4 mt-auto pt-4 border-t border-gray-100">
                    {leader.socialMedia.twitter && (
                      <a
                        ...
                        aria-label={`Twitter of ${leader.name}`}
                    ...
                    {leader.socialMedia.facebook && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label={`Facebook of ${leader.name}`}
                    ...
                    {leader.socialMedia.instagram && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label={`Instagram of ${leader.name}`}
                        className="text-gray-400 hover:text-pink-500 transition-colors transform hover:scale-125"
                      >
                        <FaInstagram size={20} />
                      </a>
                    )}
                    {leader.socialMedia.youtube && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label={`YouTube of ${leader.name}`}
                        className="text-gray-400 hover:text-red-600 transition-colors transform hover:scale-125"
                      >
                        <FaYoutube size={20} />
                      </a>
                    )}
