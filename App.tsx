...
import SiddaramaiahProfilePage from './components/SiddaramaiahProfilePage';
import DKShivakumarProfilePage from './components/DKShivakumarProfilePage';
    ...
    <DataProvider isAuthenticated={isAuthenticated}>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/socials/:platform" element={<OfficialSocialsPage />} />
          ...
          <Route
            path="/state-leader/:leaderId"
            element={<StateLeaderProfilePage />}
          />

          {/* Profiles */}
          <Route
            path="/siddaramaiah-profile"
            element={<SiddaramaiahProfilePage />}
          />
          <Route
            path="/dk-shivakumar-profile"
